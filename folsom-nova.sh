...
nova_install() {
	sudo apt-get -y install nova-api nova-cert nova-doc nova-objectstore nova-scheduler nova-volume rabbitmq-server novnc nova-novncproxy nova-consoleauth python-cinderclient nova-network nova-ajax-console-proxy
}
